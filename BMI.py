...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="You have Healthy ")
    elif bmi>25 and bmi<=30:
        label2.config(text="Overweight")
        label3.config(text="You have over weight compared to normal weight\n Consult doctor")

    else:
        label2.config(text="Obses")
        label3.config(text="Your healthy is in risk")



#icon
image_icon=PhotoImage(file="./bmimachine.png")
...
Button(root,text="view Report",width=15,height=2,font="arial 10 bold",bg="#1fee68",fg="white"   ,command=BMI).place(x=280,y=340)
